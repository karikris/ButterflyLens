...
This append-oriented record captures product or governance decisions made by Kris Kari. It is not a substitute for post-change review attestations.

## 2026-07-17 — Repository creation

- Create a new public repository named `karikris/ButterflyLens`.
- Use `main` directly and do not create feature branches or pull requests.
- Use the supplied ButterflyLens product, scientific-language, provenance, and competition contract as the governing scope.

## 2026-07-17 — Local agent instructions

- Add `AGENTS.md` to `.gitignore`.
- Consequence: the earlier requirement for a tracked root `AGENTS.md` is superseded. Engineering and community safeguards are kept in tracked public governance documents; the ignored path is not force-added.

## 2026-07-17 — First Nations language-name gate

- Keep the First Nations language-name dataset empty until a specific language,
  Country/community, authority or authorized publication, attribution, and
  purpose-specific permission are documented.
- Treat private storage, public display, query use, redistribution, research
