...
CRITERIA = (
    ...
    "Primary Bounded model Codex Session ID is recorded.",
    ...
    "Bounded model is a meaningful runtime component.",
    "Bounded model uses deterministic evidence tools.",
    "Bounded model cites artifacts.",
    "Bounded model does not identify species from memory.",
    "Bounded model cannot fabricate map counts.",
    "Bounded model can explain community impact.",
    "Bounded model can recommend the next review batch.",
    ...
    "README clearly explains Codex and Bounded model.",
    ...
    "Judges can use Bounded model replay.",
